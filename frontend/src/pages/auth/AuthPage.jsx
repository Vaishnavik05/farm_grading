...
export default function AuthPage() {
  ...
  const handleLogin = async () => {
    try {
      ...
      login("plain-session", currentUser);
      navigate(roleRoutes[currentUser.role] || "/admin");
    } catch (error) {
      setMessage(getErrorMessage(error, "Invalid credentials"));
    }
  };
  ...
  const handleSignup = async () => {
    try {
      ...
      setMessage(getErrorMessage(error, "Signup failed. Try again."));
    }
  };
